...
public class AttachmentController {
	...
	@PostMapping(value = "/{attachmentParentReferenceId}", consumes = MediaType.MULTIPART_FORM_DATA_VALUE,
	...
	@DeleteMapping(value = "/{attachmentParentReferenceId}", produces = MediaType.APPLICATION_JSON_VALUE)
